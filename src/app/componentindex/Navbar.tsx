...
const Navbar = () => {
  ...
  return (
    <nav className={`bg-bgphotoblue fixed w-full max-w-full top-0 left-0 z-50 shadow-md transition-transform duration-300 ${visible ? 'translate-y-0' : '-translate-y-full'}`}>
