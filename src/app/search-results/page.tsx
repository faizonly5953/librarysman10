  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-full mx-auto px-4 pt-5 bg-orange-50">
          <h1 className="text-xl md:text-2xl font-serif text-center text-gray-800">Search Results</h1>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        {filteredBooks.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="border-2 hover:border-orange-200 rounded-lg">
